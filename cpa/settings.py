...
SECRET_KEY = 'django-insecure-o4p)ofwu=b4(1xnd2)m*7whjjduq)(=6v5npnguud$+wl(c&e^'
...
CKEDITOR_UPLOAD_PATH = 'uploads/'  # Choose your desired upload path
CKEDITOR_CONFIGS = {
    'default': {
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'web.context_processors.custom_data',
            ],
        },
    },
]
